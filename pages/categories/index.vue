  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
      ...
      <div class="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
        ...
        <div class="group relative" v-for="category in categories" :key="category">
          ...
          <PowerIcon class="h-full w-full object-cover object-center"/>
          </div>
          ...
          <p class="text-base font-semibold text-gray-900">{{category}} - describe </p>
     </NuxtLink>   </div>
